...
namespace WebApplication1.Controllers
{
    public class InsuranceController : Controller
    {
        ...
        public ActionResult Create([Bind(Include="InsuranceId,Name,PhoneNo,Address,Email,SumAssured,InsCode,Premium,DOS,Nominee")] Insurance insurance)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include="InsuranceId,Name,PhoneNo,Address,Email,SumAssured,InsCode,Premium,DOS,Nominee")] Insurance insurance)
        {
            if (ModelState.IsValid)
            {
